...
from functions import start, bored, gif, github, soap_country, gravatar, weather, translate, numbers, exc_rates, http_cats, swear, speller, wikipedia, accuweather, openweather
...
@bot.message_handler(commands=BOT_FUNCTIONS['bored'].commands)
def get_some_action(message):
    result = bored.main()
